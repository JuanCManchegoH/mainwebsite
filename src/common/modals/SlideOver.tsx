      ...
      <Transition.Root show={open} as={Fragment}>
        <Dialog as="div" className="relative z-[100]" onClose={setOpen}>
          ...
          >
            <div
              role="presentation"
              className="fixed inset-0 bg-slate-800 bg-opacity-40 transition-opacity"
            />
          </Transition.Child>
                  ...
                  <Dialog.Panel className="pointer-events-auto mx-auto max-w-2xl p-2">
                    <div className="flex h-full flex-col backdrop-blur-xl bg-bgWhiteSlideOver rounded-xl p-2" style={{ boxShadow: "0 0 4px rgba(0,0,0,0.3)" }}>
                      ...
                      <div className="flex w-full items-start justify-between text-center mb-3">
                        <div className="w-full flex justify-center">
                          <div className="space-y-1">
                            <Dialog.Title className="text-base font-bold text-slate-900 text-center uppercase">
                              {title}
                            </Dialog.Title>
                            <p className="text-sm font-medium bg-teal-500/40 text-teal-500 rounded-full text-center px-2">
                              {description}
                            </p>
                          </div>
                        </div>
                      ...
                      <div className="h-full overflow-y-auto">
                        <div className="h-full rounded-md overflow-y-auto space-y-4">
                          {children}
                        </div>
                      </div>
                    </div>
