    ...
    <div className="bg-white py-32">
      <div className="mx-auto max-w-7xl px-6 text-center lg:px-8">
        <div className="mx-auto max-w-2xl">
          ...
          <p className="mt-4 text-lg leading-8 text-gray-600">Este es nuestro Equipo, trabajamos para brindarte herramientas que puedas integrar en los procesos de tu empresa.</p>
        </div>
