    ...
    <div className="bg-white py-24 sm:py-32">
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-none">
          <p className="text-4xl font-bold tracking-tight text-gray-900 sm:text-5xl ">Conoce nuetras caracteristicas</p>
          <p className="mt-6 text-lg  leading-8 text-gray-900">
            ...
            trabajo para satisfacer las necesidades de los clientes y asignar el personal adecuado, así como programaciones detalladas para el personal, incluyendo turnos y descansos mensuales. Con el
            fin de brindar un seguimiento efectivo, Prisma ofrece estadísticas detalladas y una vista general en tiempo real de la programación de personal. Con estos servicios, Prisma asegura la
