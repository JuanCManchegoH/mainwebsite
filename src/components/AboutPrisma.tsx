  ...
  return (
    <section id="AboutPrisma" className="py-20 sm:py-32">
      <div className="mx-auto max-w-2xl sm:text-center">
        <h2 className="text-3xl font-medium tracking-tight text-orange-500">Características principales.</h2>
      ...
      <ul className="mx-auto mt-16 grid max-w-2xl grid-cols-1 gap-6 text-sm sm:mt-20 sm:grid-cols-2 md:gap-y-10 lg:max-w-none lg:grid-cols-2" style={{ padding: '0 8rem' }}>
