      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto max-w-2xl lg:mx-0">
          ...
          <p className="mt-6 text-lg leading-8 text-gray-300">
            En MAIN, nos especializamos en estudiar, diseñar y desarrollar aplicaciones para ayudar en los procesos internos de las empresas, podrás optimizar la eficiencia y agilidad de esos
            procesos, y dejar que la automatización haga el trabajo pesado por ti. Confía en nosotros para llevar tu empresa al siguiente nivel y ser líderes en tu industria. ¡Únete a la innovación
            con MAIN!
          </p>
        </div>
